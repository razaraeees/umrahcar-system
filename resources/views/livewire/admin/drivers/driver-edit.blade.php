<div>
    <div class="page-content">
        <div class="container-fluid">
            ...
            <livewire:admin.components.breadcrumbs title="Edit Driver" bredcrumb1="Cars & Driver"
                bredcrumb2="Edit Driver" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                id="dl_expiry" wire:model="dl_expiry" min="{{ date('Y-m-d') }}">
                                            @error('dl_expiry')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div id="driver_image_preview" class="mt-2">
                                                ...
                                                @elseif ($driver->driver_image)
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('storage/' . $driver->driver_image) }}" alt="Driver Avatar"
                                                            class="img-thumbnail" style="max-height: 100px;">
                                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="window.open('{{ asset('storage/' . $driver->driver_image) }}', '_blank')">
                                                            <i class="fas fa-eye"></i> View
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-danger" wire:click="removeDriverImage">
                                            ...
                                            <div id="car_image_preview" class="mt-2">
                                                @if ($car_image)
                                                    <img src="{{ $car_image->temporaryUrl() }}" alt="Car Image"
                                                        class="img-thumbnail" style="max-height: 100px;">
                                                @elseif ($driver->car_image)
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('storage/' . $driver->car_image) }}" alt="Car Image"
                                                            class="img-thumbnail" style="max-height: 100px;">
                                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="window.open('{{ asset('storage/' . $driver->car_image) }}', '_blank')">
                                                            <i class="fas fa-eye"></i> View
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-danger" wire:click="removeCarImage">
                                                            <i class="fas fa-times"></i>
                                                        </button>
                                                    </div>
                                                @endif
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                @if ($driver->rc_copy) disabled @endif>
                                            @error('rc_copy')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div id="rc_copy_preview" class="mt-2">
                                                @if ($driver->rc_copy)
                                                    <div class="alert alert-info py-2">
                                                        ...
                                                        <small>Please remove the existing preview to enter a new document</small>
                                                    </div>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="window.open('{{ asset('storage/' . $driver->rc_copy) }}', '_blank')">
                                                            <i class="fas fa-eye"></i> Preview
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-danger" wire:click="removeExistingRcCopy">
                                                            <i class="fas fa-times"></i> Remove
                                                        </button>
                                                        <small class="text-muted">Existing file</small>
                                                    </div>
                                                @elseif ($rc_copy)
                                                    <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                @if ($driver->insurance_copy) disabled @endif>
                                            @error('insurance_copy')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div id="insurance_copy_preview" class="mt-2">
                                                @if ($driver->insurance_copy)
                                                    <div class="alert alert-info py-2">
                                                        <i class="fas fa-info-circle"></i> 
                                                        <small>Please remove the existing preview to enter a new document</small>
                                                    </div>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="window.open('{{ asset('storage/' . $driver->insurance_copy) }}', '_blank')">
                                                            <i class="fas fa-eye"></i> Preview
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-danger" wire:click="removeExistingInsuranceCopy">
                                                            <i class="fas fa-times"></i> Remove
                                                        </button>
                                                        <small class="text-muted">Existing file</small>
                                                    </div>
                                                @elseif ($insurance_copy)
                                                    <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                @if ($driver->driving_license) disabled @endif>
                                            ...
                                            <div id="driving_license_preview" class="mt-2">
                                                @if ($driver->driving_license)
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="window.open('{{ asset('storage/' . $driver->driving_license) }}', '_blank')">
                                                            <i class="fas fa-eye"></i> Preview
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-outline-danger" wire:click="removeExistingDrivingLicense">
                                                            <i class="fas fa-times"></i> Remove
                                                        </button>
                                                        <small class="text-muted">Existing file</small>
                                                    </div>
